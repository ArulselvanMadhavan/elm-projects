...
tests =
    describe "Pangram"
        ...
        , test "Pangram with Edge cases" <|
            \() -> Expect.equal False (isPangram "@'`[{ZZZZZZAAAAAAAAAAsadasdasdasdqweqweqweuoiyeoquyrqnmbanxb,gakjshdsadylioypqyweoiwqe8qwyeipqwuoyetqwoey")
        ]
