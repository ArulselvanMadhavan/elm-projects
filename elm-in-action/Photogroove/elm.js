...
var _user$project$PhotoGroove$randomPhotos = A2(
		...
		switch (_p2.ctor) {
			...
			case 'SurpriseMe':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_elm_lang$core$Random$generate, _user$project$PhotoGroove$SelectByIndex, _user$project$PhotoGroove$randomPhotos)
				};
			default:
				return {
					ctor: '_Tuple2',
